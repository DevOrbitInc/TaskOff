function LoadingState() {
  return (
    <div className="min-w-[700px] bg-white">
      ...
      {[1, 2, 3, 4].map((row) => (
        <div key={row} className="grid min-h-[44px] grid-cols-[minmax(260px,1fr)_132px_94px_72px] items-center gap-3 border-b border-gray-100 px-5 py-2">
          <div className="space-y-1.5"><div className="h-2 w-8 animate-pulse rounded bg-gray-200" /><div className="h-2 w-40 animate-pulse rounded bg-gray-200" /></div>
